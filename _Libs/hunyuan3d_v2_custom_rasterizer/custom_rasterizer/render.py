...
import hunyuan3d_v2_custom_rasterizer_kernel
import torch


def rasterize(pos, tri, resolution, clamp_depth=torch.zeros(0), use_depth_prior=0):
    assert (pos.device == tri.device)
    findices, barycentric = hunyuan3d_v2_custom_rasterizer_kernel.rasterize_image(pos[0], tri, clamp_depth, resolution[1],
